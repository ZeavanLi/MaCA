...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent1", type=str, default="DQN_1v1", help='agent 1 name, only name, not path')
    parser.add_argument("--agent2", type=str, default="DQN_1v1", help='agent 2 name, only name, not path')
